...
function vowelBonusScore(word){
   ...
   letterPoints = 0
      for(let i=0; i<vowelBonusScoreArray[i] === 'A' ||
...
console.log (`Score for '${wordToSave}':
${scoringAlgorithms[scorerPromptToSave].scoringFunction(wordToSave)}`)
}
